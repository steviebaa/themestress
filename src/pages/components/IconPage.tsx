...
export const IconPage = () => {
  return (
    <>
      <PageHeader />
      <P>
        An <Code>svg</Code> element (wrapper) where the child element should be
        a <Code>path</Code> element.
      </P>
      <SampleBox>
        <Icon size="80px" fill={['warning', 'main']}>
      ...
      <TypeScript code={samples.icon.overview} />
