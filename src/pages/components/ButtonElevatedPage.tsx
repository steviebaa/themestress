...
import {Button, ButtonElevated} from '@themestress/components';
import {CheckRounded} from '@themestress/icons';
import {ApiTable} from '@components/ApiTable';
import {PageHeader} from '@components/ImportSample';
import {ReactHTMLProps} from '@themestress/core';

export const ButtonElevatedPage = () => {
  const icon = (
  ...
  return (
    <>
      <PageHeader />
      <P>This is the Elevated Button Yooo.</P>

      <SampleBox>
        <ButtonElevated icon={icon}>Elevated Icon Button</ButtonElevated>

        <ButtonElevated>Elevated Button</ButtonElevated>
      </SampleBox>
    </>
  );
};
