  ...
  static get = {
    ...
    green: (color: string) => {
      if (ColorUtility.hex.isValid(color))
        ...
        return ColorUtility.rgb.get.green(ColorUtility.hsl.to.rgb(color));
      else if (ColorUtility.css.isValid(color))
        return ColorUtility.rgb.get.green(ColorUtility.css.to.rgb(color));
    ...
    blue: (color: string) => {
      if (ColorUtility.hex.isValid(color))
        ...
        return ColorUtility.rgb.get.blue(ColorUtility.hsl.to.rgb(color));
      else if (ColorUtility.css.isValid(color))
        return ColorUtility.rgb.get.blue(ColorUtility.css.to.rgb(color));
    ...
    saturation: (color: string) => {
      if (ColorUtility.hex.isValid(color))
        return ColorUtility.hsl.get.saturation(ColorUtility.hex.to.hsl(color));
      else if (ColorUtility.rgb.isValid(color))
    ...
    lightness: (color: string) => {
      if (ColorUtility.hex.isValid(color))
        return ColorUtility.hsl.get.lightness(ColorUtility.hex.to.hsl(color));
      else if (ColorUtility.rgb.isValid(color))
